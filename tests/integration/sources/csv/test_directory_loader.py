...
class TestCSVDirectoryLoader:
    ...
    def test_load_directory_all_files(self, duckdb_conn, session):
    ...
    def test_load_directory_with_pattern(self, duckdb_conn, session):
    ...
    def test_load_directory_not_found(self, duckdb_conn, session):
    ...
    def test_load_directory_empty_pattern(self, duckdb_conn, session):
    ...
    def test_load_directory_total_rows(self, duckdb_conn, session):
